...
public class FlatFileConnectorConfiguration extends AbstractConfiguration {
    ...
    @ConfigurationProperty(order = 1, required = true,
                           helpMessageKey = "configuration.lookupReconFile.help",
                           displayMessageKey =
    ...
    @ConfigurationProperty(order = 1, required = false,
                           helpMessageKey = "configuration.customscriptfileforrecon.help",
                           displayMessageKey =
    ...
    @ConfigurationProperty(order = 1, required = false,
                           helpMessageKey = "configuration.customscriptfileforprovisioning.help",
                           displayMessageKey =
    ...
    @ConfigurationProperty(order = 1, required = true,
                           helpMessageKey = "configuration.targetfile.help",
                           displayMessageKey =
    ...
    @ConfigurationProperty(required = true,
                           helpMessageKey = "configuration.uniqueattribute.help",
                           displayMessageKey =
                           "configuration.uniqueattribute.display")
            ...
            for (PropertyDescriptor propertyDescriptor : propertyDescs) {
                ...
                if (annotation != null && annotation.required()) {
                    ...
                    if (value == null) {
                        ...
                        throw new ConfigurationException(getMessage("validate.missingPropertyValue",
    ...
    @ConfigurationProperty(required = true,
                           helpMessageKey = "configuration.hostName.help",
                           displayMessageKey =
                           "configuration.hostName.display")
    ...
    @ConfigurationProperty(required = true,
                           helpMessageKey = "configuration.userName.help",
                           displayMessageKey =
                           "configuration.userName.display")
    ...
    @ConfigurationProperty(required = true,
                           helpMessageKey = "configuration.password.help",
                           displayMessageKey =
