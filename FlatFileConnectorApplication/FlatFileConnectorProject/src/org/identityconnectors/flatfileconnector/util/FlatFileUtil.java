...
public final class FlatFileUtil {
     ...
     * @return
     */
    public static Uid createAccount(Set<Attribute> arg1, File targetFile,
                                    String uidAttribute) {
    ...
    private static String getAttributeValue(Set<Attribute> attributes,
                                            String name) {
        String value = null;
        ...
        try {
            while ((s = reader.readLine()) != null) {
                ...
                while (sc.hasNext()) {
                    ...
                    if (existingAccountID.equalsIgnoreCase(strArray[strArray.length -
                                                           1])) {
                        accountExist = true;
                    }
                }
    ...
    public static StringBuffer checkAndGetUpdateAttributes(Uid arg1,
                                                           Set<Attribute> arg2,
                                                           File targetFile) {
        ...
        for (Attribute attr : arg2) {
            ...
            // We wan't to discard the __CURRENT_PASSWORD__ attributes, since we don't want this in the flat file
                    ...
                    for (Attribute attr : updatedAttributes) {
                        ...
                        if (attr.getName().equalsIgnoreCase(FlatFileUtil.Role)) {
                            ...
                            if (strArray.length > 1 && strArray[1] != null) {
                                ...
                                updatedLine.append(";");
                                Scanner sc1 =
                                    new Scanner(strArray[1]).useDelimiter(";");
                                int i = 0;
                                while (sc1.hasNext()) {
                                    if (i == 0) {
                                        sc1.next();
                                ...
                                System.out.println("Updating to value " +
                                                   attr.getValue().get(0));
                                updatedLine.append(attr.getName());
                                updatedLine.append(":");
                                updatedLine.append(attr.getValue().get(0));
    ...
    public static void writeUpdatedContent(StringBuffer updatedContent,
                                           File file) {
