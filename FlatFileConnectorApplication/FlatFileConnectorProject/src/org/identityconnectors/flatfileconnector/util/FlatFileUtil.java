...
System.out.println(" ### Attribute Name "+thisAttribute.getName() +" Value "+thisAttribute.getValue()+" ####");
...
System.out.println(" #### Found UID Attribute "+thisAttribute.getName()+ " "+thisAttribute.getValue()+" #### ");
...
System.out.println(" ### User ID is "+arg1.getName() +" Value is "+arg1.getUidValue());
for(Attribute attr:arg2){
System.out.println(" ### Changed Attribute is "+attr.getName() +" Changed Value is "+attr.getValue());
