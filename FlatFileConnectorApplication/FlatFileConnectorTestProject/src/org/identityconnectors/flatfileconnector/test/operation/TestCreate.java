...
public class TestCreate extends Test {
    ...
    private void create() {
        ...
        for (ConnectorInfo cInfo : cInfos) {
            ...
            /*connectorFacade.create(ObjectClass.ACCOUNT, createAttributes("1"),
                                   null);
            connectorFacade.create(ObjectClass.ACCOUNT, createAttributes("2"),
                                   null);
            connectorFacade.create(ObjectClass.ACCOUNT, createAttributes("3"),
                                   null);*/
            //lets call the create operation on the facade
            connectorFacade.create(ObjectClass.ACCOUNT, createAttributes("4"), null);
            connectorFacade.create(ObjectClass.ACCOUNT, createAttributes("2"), null);
            connectorFacade.create(ObjectClass.ACCOUNT, createAttributes("3"), null);
        }
    }
